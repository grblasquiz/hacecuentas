...
scripts/calcs-global-100-specs.json. Cada spec lleva un campo `lang` que
...
Output:
  ...
  scripts/.batch-global-state.json   — checkpoint
...
SPECS_FILE = ROOT / "scripts" / "calcs-global-100-specs.json"
FORMULAS_DIR = ROOT / "src" / "lib" / "formulas"
STATE_FILE = ROOT / "scripts" / ".batch-global-state.json"
