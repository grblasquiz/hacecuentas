...
export const hub: HubData = {
  ...
  description: 'Calcula el costo puesto en México de una importación: mercancía, flete, seguro, IGI, DTA, IVA, agente aduanal y costo final por unidad.',
  silo: 'Impuestos',
  ...
  inputsIntro: 'Usa la cotización real y la tasa correspondiente a la fracción arancelaria. Todos los porcentajes son editables.',
  fields: [
    ...
    { id: 'tipoCambio', label: 'Tipo de cambio aduanero (MXN por USD)', prefix: '$', value: 18.5, min: 0.01, step: 0.0001, help: 'Usa el tipo de cambio aplicable a la fecha del pedimento.' },
  ...
  faq: [
    ...
    { q: '¿Incluye NOM, permisos, IEPS o cuotas compensatorias?', a: 'No de forma automática. Esos conceptos dependen del producto y deben confirmarse antes de comprar. Puedes incorporarlos en otros gastos para estimar caja, pero no reemplaza la clasificación formal.' },
    { q: '¿Puedo usarla para importar un auto?', a: 'No es la mejor herramienta: los vehículos agregan ISAN, reglas por año-modelo y requisitos propios. Para eso usa el hub Comprar o vender auto en México.' },
