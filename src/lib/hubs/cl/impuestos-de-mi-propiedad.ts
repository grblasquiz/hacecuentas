...
export const hub: HubData = {
  ...
  replaces: [
    ...
    '/cl/calculadora-contribuciones-morosas-tgr-chile-intereses-reajuste',
    '/cl/calculadora-impuesto-mayor-valor-venta-propiedad-chile-8000-uf',
    '/cl/calculadora-impuesto-timbres-estampillas-chile-credito-hipotecario',
    '/cl/calculadora-impuesto-herencias-donaciones-chile-tabla',
  ],
