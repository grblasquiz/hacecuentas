...
export const FINDE_HUBS: FindeHubDef[] = [
  {
    ...
    lede: 'La juntada perfecta empieza por no quedarte corto ni tirar comida. Reunimos las calculadoras que te dicen exactamente cuánto comprar de cada cosa —carne, pan, ensalada, bebidas, café, pizza, empanadas y postre— según cuántos van a comer. Cargás los invitados una vez y salís a comprar con la lista justa, con un margen sano para el que cae sin avisar. Cada herramienta usa porciones de referencia probadas (por ejemplo, 3 porciones de pizza o 6 empanadas por adulto, o 500 g de carne para el asado) y ajusta las cantidades cuando hay chicos en la mesa. Así organizás desde una picada para la previa hasta un almuerzo de veinte personas sin adivinar, sin sobras que se echan a perder y sin ese viaje de último momento al súper cuando ya están todos sentados a la mesa.',
  ...
  },
  {
    ...
    lede: 'Un cumpleaños, un after o una reunión grande se van de presupuesto por los detalles que nadie calcula: los vasos descartables, el hielo, las sillas, cuánta bebida por invitado. Este hub junta las herramientas para que armes la fiesta con números, no a ojo, y sepas cuánto vas a gastar antes de empezar. Empezás por el presupuesto total y por invitado, seguís con la bebida (cerveza, vino, fernet y agua según las horas), resolvés la vajilla descartable, sentás a todos con las sillas y mesas necesarias y cerrás con el cotillón y los souvenirs. Cada calculadora usa tus propios precios —no inventamos costos, porque varían por zona y proveedor— así que el número final es realista. La idea es simple: planificar de antemano te evita el susto cuando llega la cuenta y el viaje al kiosco a mitad de la fiesta.',
  ...
  },
  {
    ...
    lede: 'Una escapada de fin de semana se disfruta más cuando sabés cuánto vas a gastar antes de salir. Este hub reúne las calculadoras para estimar la nafta y los peajes, el hospedaje, el presupuesto total del viaje y cuánto le toca a cada uno, así arrancás tranquilo y sin sorpresas en la tarjeta. Cargás la distancia y el consumo de tu auto para saber los litros y el costo de combustible, sumás las noches de hospedaje por el precio por noche, agregás comidas y actividades y tenés el presupuesto completo por día y por persona. Todos los precios los ponés vos —no consultamos ni inventamos tarifas—, de modo que el total refleja tu viaje real. Y cuando volvés, la calculadora de dividir gastos deja claro cuánto puso cada uno, sin la discusión de "quién pagó qué" al final del fin de semana.',
  ...
  },
  {
    ...
    lede: 'El finde de arreglar la casa se arruina cuando faltan tres cajas de cerámicos o sobran cuatro latas de pintura. Este hub reúne las calculadoras de materiales para que estimes lo justo —con su margen de desperdicio— antes de ir al corralón: pintura, pisos, contrapiso, machimbre, adoquines, tierra para el jardín y mucho más. Cada herramienta parte de una medida simple (los metros cuadrados o lineales del área) y aplica fórmulas geométricas verificables más el porcentaje de desperdicio recomendado para cortes y roturas, así comprás en las unidades reales de venta: latas, cajas, bolsas o planchas. Los precios los sumás vos con los valores de tu corralón, porque cambian por zona y marca. La meta es que el proyecto del sábado salga a la primera: sin frenar la obra por un material que faltó ni inmovilizar plata en bolsas que después sobran en el garage.',
