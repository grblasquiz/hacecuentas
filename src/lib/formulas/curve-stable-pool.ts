...
export interface Outputs { totalApy: number; baseFees: number; crvRewards: number; extraRewards: number; totalUsd: number; finalValue: number; explicacion: string; _chart?: any; }
