...
export function irpfCataluna2026(i: Inputs): Outputs {
  ...
  const _insight = {
    ...
    text: `Sobre ${fmtEUR(salario)} brutos pagás **${fmtEUR(cuotaTotal)}** de IRPF (estatal + Cataluña, de los tramos autonómicos más altos de España), un tipo efectivo del **${tipoEfectivoPct}%**. Te quedan **${fmtEUR(netoMensual)}/mes** netos en 14 pagas.`,
    tone,
    icon: '🪙',
  };
