...
import { aberturaPvcVsAluminioAhorroAnual } from './abertura-pvc-vs-aluminio-ahorro-anual';
...
import { actualizacionAlquilerIravEspana } from './actualizacion-alquiler-irav-espana';
import { acuarioIluminacionWattsLitrosPlantado } from './acuario-iluminacion-watts-litros-plantado';
...
import { compute as compute__agent_tokens_loop_recursion_presupuesto_mensual } from './agent-tokens-loop-recursion-presupuesto-mensual';
import { agenteIaMcpServidorCostoMensual } from './agente-ia-mcp-servidor-costo-mensual';
...
import { compute as compute__agua_diaria_litros_segun_peso } from './agua-diaria-litros-segun-peso';
...
import { compute as compute__ahorro_futuro_hijo_universidad_18_anos } from './ahorro-futuro-hijo-universidad-18-anos';
import { ahorroGncVsNaftaAnualArs } from './ahorro-gnc-vs-nafta-anual-ars';
import { ahorroHormiga } from './ahorro-hormiga';
import { ahorroLedVsComun } from './ahorro-led-vs-comun';
...
import { airdropElegibilidadWalletScorePuntaje } from './airdrop-elegibilidad-wallet-score-puntaje';
...
import { alfombraTamanoLiving } from './alfombra-tamano-living';
...
import { amortizacionPaseFifa } from './amortizacion-pase-fifa';
...
import { compute as compute__aprender_portugues_brasil_vs_portugal_tiempo } from './aprender-portugues-brasil-vs-portugal-tiempo';
...
import { asistenciasPor90 } from './asistencias-por-90';
...
import { compute as compute__axolotl_acuario_tamano_temperatura_litros } from './axolotl-acuario-tamano-temperatura-litros';
...
import { balanceoEcuacionQuimica } from './balanceo-ecuacion-quimica';
...
import { compute as compute__batch_api_openai_anthropic_50_descuento_cuando } from './batch-api-openai-anthropic-50-descuento-cuando';
...
import { betaAccionRiesgo } from './beta-accion-riesgo';
import { betaHcg } from './beta-hcg';
import { biberonesNecesariosPrimeraInfancia } from './biberones-necesarios-primera-infancia';
import { compute as compute__bichon_maltes_grooming_frecuencia_costo_anual } from './bichon-maltes-grooming-frecuencia-costo-anual';
import { compute as compute__bicicleta_electrica_asistida_tco_mes_vs_auto_moto } from './bicicleta-electrica-asistida-tco-mes-vs-auto-moto';
...
import { compute as compute__bitcoin_cpa_iva_trader_argentina_impuestos_2026 } from './bitcoin-cpa-iva-trader-argentina-impuestos-2026';
...
import { bjjCinturonGradosTiempoPromedio } from './bjj-cinturon-grados-tiempo-promedio';
import { blackFridayDescuentoReal } from './black-friday-descuento-real';
...
import { compute as compute__body_fat_jackson_pollock_calculator } from './body-fat-jackson-pollock-calculator';
...
import { bosmanLibreCosto } from './bosman-libre-costo';
...
import { breakEvenCampanaPublicitaria } from './break-even-campana-publicitaria';
...
import { bridgingStablecoinArbitrumOptimismFee } from './bridging-stablecoin-arbitrum-optimism-fee';
...
import { compute as compute__burnout_test_maslach_puntaje_online_empleado } from './burnout-test-maslach-puntaje-online-empleado';
import { caballoPensionMesClubHipico } from './caballo-pension-mes-club-hipico';
...
import { cacPaybackMesesRecuperarCliente } from './cac-payback-meses-recuperar-cliente';
...
import { caloriasQuemadasCaminando } from './calculadora-calorias-quemadas-caminando';
...
import { caloriasArqueroFutbol } from './calorias-arquero-futbol';
...
import { caloriasCrossfitWod } from './calorias-crossfit-wod';
import { caloriasCuerda } from './calorias-cuerda';
import { caloriasDelantero } from './calorias-delantero';
...
import { caloriasPickleball } from './calorias-pickleball';
...
import { capacidadTanqueAguaLitros } from './capacidad-tanque-agua-litros';
...
import { cargadorAutoElectricoHogar7Kw22Kw } from './cargador-auto-electrico-hogar-7kw-22kw';
import { compute as compute__cargador_hogar_wallbox_vs_publico_costo_anual } from './cargador-hogar-wallbox-vs-publico-costo-anual';
...
import { cigarrillosAhorro } from './cigarrillos-ahorro';
...
import { compute as compute__cisterna_tanque_agua_litros_personas_presion } from './cisterna-tanque-agua-litros-personas-presion';
...
import { claudeCodeCostoMensualUsoDeveloper } from './claude-code-costo-mensual-uso-developer';
...
import { cleanSheetsPorcentaje } from './clean-sheets-porcentaje';
...
import { colivingPrecioMesBaliMedellinMexico } from './coliving-precio-mes-bali-medellin-mexico';
...
import { compute as compute__comida_golden_retriever_cantidad_cachorro_adulto } from './comida-golden-retriever-cantidad-cachorro-adulto';
...
import { comisionBrokerCocosIolBullComparativa } from './comision-broker-cocos-iol-bull-comparativa';
...
import { compute as compute__comprar_acciones_bvc_colombia_comisiones_impuesto } from './comprar-acciones-bvc-colombia-comisiones-impuesto';
...
import { computoPrisionPreventiva } from './computo-prision-preventiva';
...
import { conejoAlimentoPelletHenoMesKg } from './conejo-alimento-pellet-heno-mes-kg';
...
import { conmocionCerebralProtocoloFifa } from './conmocion-cerebral-protocolo-fifa';
...
import { conversionCriptoArs } from './conversion-cripto-ars';
...
import { costoAbonoBundesligaPremier } from './costo-abono-bundesliga-premier';
import { costoAdquisicionSeguidorPagoPaidSocial } from './costo-adquisicion-seguidor-pago-paid-social';
...
import { costoMascotaMensual } from './costo-mascota-mensual';
...
import { costoPorLeadCplCampana } from './costo-por-lead-cpl-campana';
...
import { coworkingPrecioMesFlexFijoComparativa } from './coworking-precio-mes-flex-fijo-comparativa';
import { cpa } from './cpa';
import { cpaMaximoRentableTargetCpa } from './cpa-maximo-rentable-target-cpa';
...
import { compute as compute__cripto_cedears_versus_usd_broker_rentabilidad_ar } from './cripto-cedears-versus-usd-broker-rentabilidad-ar';
...
import { cunaColechoEdadTransicionCamaNinos } from './cuna-colecho-edad-transicion-cama-ninos';
...
import { cuotasMercadoPagoCft } from './cuotas-mercado-pago-cft';
import { cuotasSinInteresPrecio } from './cuotas-sin-interes-precio';
import { cuotasVsContadoInflacionAr } from './cuotas-vs-contado-inflacion-ar';
...
import { cuposConferenceLeague } from './cupos-conference-league';
...
import { daoQuorumPropuestaVotacionToken } from './dao-quorum-propuesta-votacion-token';
...
import { compute as compute__deel_vs_payoneer_vs_wise_comision_empleado_eeuu } from './deel-vs-payoneer-vs-wise-comision-empleado-eeuu';
...
import { depreciacionValorJugadorEdad } from './depreciacion-valor-jugador-edad';
import { depresionPospartoTest } from './depresion-posparto-test';
import { derechosImagenComision } from './derechos-imagen-comision';
...
import { descensoBrasileirao } from './descenso-brasileirao';
import { descensoBundesliga } from './descenso-bundesliga';
...
import { descensoPremierLeague } from './descenso-premier-league';
...
import { compute as compute__detector_humedad_pared_tipo_tratamiento_costo } from './detector-humedad-pared-tipo-tratamiento-costo';
...
import { dilucionSolucionC1v1 } from './dilucion-solucion-c1v1';
...
import { dividendYieldAccion } from './dividend-yield-accion';
...
import { dpsDamagePerSecond } from './dps-damage-per-second';
import { drawdownMaximoAceptable } from './drawdown-maximo-aceptable';
import { drawdownMaximoInversion } from './drawdown-maximo-inversion';
...
import { compute as compute__edad_gestacional_ecografia_corona_rabadilla } from './edad-gestacional-ecografia-corona-rabadilla';
import { compute as compute__edad_gestacional_perro_gato_camada_fecha_parto } from './edad-gestacional-perro-gato-camada-fecha-parto';
...
import { compute as compute__edad_perro_gato_anos_humanos_tabla_2026_actualizada } from './edad-perro-gato-anos-humanos-tabla-2026-actualizada';
...
import { efectividadTiposPokemon } from './efectividad-tipos-pokemon';
import { efectividadTirosAlArco } from './efectividad-tiros-al-arco';
...
import { eloRatingFutbol } from './elo-rating-futbol';
...
import { embargoSueldoMaximo } from './embargo-sueldo-maximo';
import { embargoSueldoPorcentajeMaximo } from './embargo-sueldo-porcentaje-maximo';
import { embeddingVectorPineconeWeaviateCostoMes } from './embedding-vector-pinecone-weaviate-costo-mes';
...
import { compute as compute__emigrar_uruguay_presupuesto_primer_ano_familia } from './emigrar-uruguay-presupuesto-primer-ano-familia';
...
import { escalaDolorNumerica } from './escala-dolor-numerica';
...
import { escaladaGradoFrancesYdsConversion } from './escalada-grado-frances-yds-conversion';
...
import { escapeRoomProbabilidad } from './escape-room-probabilidad';
...
import { ethereumL2BaseArbitrumOptimismFeeComparativa } from './ethereum-l2-base-arbitrum-optimism-fee-comparativa';
...
import { experienciaNivelMmorpg } from './experiencia-nivel-mmorpg';
...
import { factorClimaMascotas } from './factor-clima-mascotas';
...
import { compute as compute__fecha_ovulacion_ventana_fertil } from './fecha-ovulacion-ventana-fertil';
...
import { compute as compute__fgts_multa_40_rescisao } from './fgts-multa-40-rescisao';
...
import { financiamentoSacVsPrice } from './financiamento-sac-vs-price';
import { compute as compute__financiamento_veiculo_cdc_banco } from './financiamento-veiculo-cdc-banco';
import { fineTuningLlamaCostoDatasetTokens } from './fine-tuning-llama-costo-dataset-tokens';
import { compute as compute__fine_tuning_openai_vs_rag_cuando_conviene } from './fine-tuning-openai-vs-rag-cuando-conviene';
...
import { finiquitoDespidoInjustificadoMexico } from './finiquito-despido-injustificado-mexico';
...
import { fondoEmergencia } from './fondo-emergencia';
...
import { compute as compute__freelance_tarifa_hora_vs_paquete_fijo_cuando_conviene } from './freelance-tarifa-hora-vs-paquete-fijo-cuando-conviene';
...
import { fumigacionFrecuenciaHogar } from './fumigacion-frecuencia-hogar';
...
import { generadorContrasenaSegura } from './generador-contrasena-segura';
...
import { goldenHourHorario } from './golden-hour-horario';
...
import { hashtagAlcanceEstimado } from './hashtag-alcance-estimado';
...
import { hidratacionDiariaPersonalizada } from './hidratacion-diaria-personalizada';
...
import { hidratacionFutbolista } from './hidratacion-futbolista';
...
import { hipotecaCiudadProcrear } from './hipoteca-ciudad-procrear';
...
import { hipotecaUvaBbva } from './hipoteca-uva-bbva';
...
import { homeAdvantageLiga } from './home-advantage-liga';
...
import { honorariosAbogadoLaboralMexico } from './honorarios-abogado-laboral-mexico';
...
import { honorariosEscribanoPba } from './honorarios-escribano-pba';
...
import { horasPantalla } from './horas-pantalla';
...
import { compute as compute__hourly_to_annual_salary_converter } from './hourly-to-annual-salary-converter';
import { compute as compute__hours_between_times_calculator } from './hours-between-times-calculator';
import { huellaCarbono as huellaCarbono__huella_carbono } from './huella-carbono';
...
import { huertaProduccionM2 } from './huerta-produccion-m2';
...
import { compute as compute__imagen_ai_dall_e_3_vs_midjourney_stable_diffusion_pixel } from './imagen-ai-dall-e-3-vs-midjourney-stable-diffusion-pixel';
...
import { compute as compute__impatriado_beckham_espana_impuesto_relocacion } from './impatriado-beckham-espana-impuesto-relocacion';
...
import { compute as compute__impuesto_bebidas_azucaradas_2025_colombia } from './impuesto-bebidas-azucaradas-2025-colombia';
...
import { compute as compute__impuesto_nomada_digital_residencia_fiscal_paises } from './impuesto-nomada-digital-residencia-fiscal-paises';
import { compute as compute__impuesto_pais_mep_blue_eliminacion_impacto_importacion } from './impuesto-pais-mep-blue-eliminacion-impacto-importacion';
...
import { compute as compute__impuesto_seguro_vida_chile_prima_deduccion } from './impuesto-seguro-vida-chile-prima-deduccion';
...
import { indiceTobilloBrazo } from './indice-tobillo-brazo';
...
import { compute as compute__instagram_ads_presupuesto_cpm_cpr_roi_2026 } from './instagram-ads-presupuesto-cpm-cpr-roi-2026';
...
import { compute as compute__iva_espana_2026_21_tipo_general_formula } from './iva-espana-2026-21-tipo-general-formula';
...
import { compute as compute__japones_jlpt_n5_n4_n3_horas_meta_aprobar } from './japones-jlpt-n5-n4-n3-horas-meta-aprobar';
...
import { compute as compute__kdrama_bingear_horas_temporadas_recomendado } from './kdrama-bingear-horas-temporadas-recomendado';
...
import { lactarioLecheMaternaExtraccionFrecuenciaStock } from './lactario-leche-materna-extraccion-frecuencia-stock';
...
import { licenciaAdopcionLct } from './licencia-adopcion-lct';
...
import { licenciaMatrimonioLct158 } from './licencia-matrimonio-lct-158';
...
import { ligaMxLiguilla } from './liga-mx-liguilla';
...
import { compute as compute__llm_context_window_200k_vs_1m_cuando_conviene } from './llm-context-window-200k-vs-1m-cuando-conviene';
...
import { lollapaloozaArgentina2026PrecioAbonoDia } from './lollapalooza-argentina-2026-precio-abono-dia';
...
import { magnitudAparenteAbsoluta } from './magnitud-aparente-absoluta';
...
import { margenSeguridadInversion } from './margen-seguridad-inversion';
...
import { compute as compute__master_mba_roi_costo_vs_aumento_sueldo_anos_recuperar } from './master-mba-roi-costo-vs-aumento-sueldo-anos-recuperar';
import { compute as compute__master_oficial_titulo_propio_precio_espana } from './master-oficial-titulo-propio-precio-espana';
import { compute as compute__mate_yerba_cantidad_mate_cebados_dia_grupo } from './mate-yerba-cantidad-mate-cebados-dia-grupo';
...
import { compute as compute__mcp_server_costo_hosting_cloudflare_vs_aws } from './mcp-server-costo-hosting-cloudflare-vs-aws';
...
import { mediaMedianaModa } from './media-mediana-moda';
...
import { compute as compute__meditacion_minutos_ansiedad_cortisol_impacto } from './meditacion-minutos-ansiedad-cortisol-impacto';
import { meditacionMinutosBeneficio } from './meditacion-minutos-beneficio';
...
import { compute as compute__melatonina_dosis_jet_lag_edad_tomar_cuando } from './melatonina-dosis-jet-lag-edad-tomar-cuando';
...
import { mezclaAudioHeadroomDb } from './mezcla-audio-headroom-db';
import { mezclaPresupuestoCanalesMarketing } from './mezcla-presupuesto-canales-marketing';
...
import { midjourneyVsDalleCostoImagenComparativa } from './midjourney-vs-dalle-costo-imagen-comparativa';
...
import { compute as compute__modelo_local_ollama_vs_api_openai_costo_tco } from './modelo-local-ollama-vs-api-openai-costo-tco';
...
import { mrr } from './mrr';
import { mudanzaCajasEstimacion } from './mudanza-cajas-estimacion';
...
import { nodeValidadorEthereum32EthRendimiento } from './node-validador-ethereum-32-eth-rendimiento';
import { nomadaDigitalResidenciaFiscalImpuestos } from './nomada-digital-residencia-fiscal-impuestos';
...
import { compute as compute__one_rep_max_epley_brzycki_calculator } from './one-rep-max-epley-brzycki-calculator';
...
import { padelHandicapPuntajeRankingAft } from './padel-handicap-puntaje-ranking-aft';
import { padelPelotaPresionAlturaPico } from './padel-pelota-presion-altura-pico';
...
import { paroAutonomosCeseActividadEspana } from './paro-autonomos-cese-actividad-espana';
import { paroEspanaSepe } from './paro-espana-sepe';
...
import { payrollInternacionalDeelRemoteCostoEmpleado } from './payroll-internacional-deel-remote-costo-empleado';
...
import { compute as compute__perro_anciano_7_anos_suplementos_diarios } from './perro-anciano-7-anos-suplementos-diarios';
import { perroDepartamentoApto } from './perro-departamento-apto';
import { perroPaseadorTarifaHoraZonaCaba } from './perro-paseador-tarifa-hora-zona-caba';
...
import { pesoIdealFormula } from './peso-ideal-formula';
import { pesoIdealFormulaLorentzDevine } from './peso-ideal-formula-lorentz-devine';
import { compute as compute__peso_ideal_formulas_comparativa_broca_devine_robinson } from './peso-ideal-formulas-comparativa-broca-devine-robinson';
...
import { pesoIdealPerroRaza } from './peso-ideal-perro-raza';
...
import { pinturaParedLitrosM2 } from './pintura-pared-litros-m2';
...
import { pisoRadianteElectricoVsAguaCosto } from './piso-radiante-electrico-vs-agua-costo';
...
import { plusvaliaRevalorizacionInmuebleProyectada } from './plusvalia-revalorizacion-inmueble-proyectada';
import { pncMadre7Hijos } from './pnc-madre-7-hijos';
import { pncVejez70Anos } from './pnc-vejez-70-anos';
...
import { compute as compute__pomodoro_output_real_distracciones_promedio } from './pomodoro-output-real-distracciones-promedio';
import { pomodoroSesionesDiaProductividadHoras } from './pomodoro-sesiones-dia-productividad-horas';
import { compute as compute__poodle_toy_vs_mediano_grande_comida_diferencia } from './poodle-toy-vs-mediano-grande-comida-diferencia';
...
import { compute as compute__portero_electrico_vs_camara_ip_departamento_comparativa } from './portero-electrico-vs-camara-ip-departamento-comparativa';
...
import { compute as compute__precio_internet_fibra_tigo_claro_etb_2026_promo } from './precio-internet-fibra-tigo-claro-etb-2026-promo';
...
import { preescolarJardinCuotaMensualComparativaPaises } from './preescolar-jardin-cuota-mensual-comparativa-paises';
...
import { premiosCopaAmerica } from './premios-copa-america';
import { premiosCopaArgentina } from './premios-copa-argentina';
import { premiosLibertadoresRonda } from './premios-libertadores-ronda';
...
import { premiosMundialClubes2025 } from './premios-mundial-clubes-2025';
import { premiosMundialClubesFifa } from './premios-mundial-clubes-fifa';
...
import { presionArterialRango } from './presion-arterial-rango';
import { presionArterialTablaNormalHipertension } from './presion-arterial-tabla-normal-hipertension';
import { compute as compute__presion_arterial_tension_categorias_oms_2026 } from './presion-arterial-tension-categorias-oms-2026';
...
import { presupuestoPautaPorObjetivo } from './presupuesto-pauta-por-objetivo';
...
import { probabilidadAprobarMultipleChoice } from './probabilidad-aprobar-multiple-choice';
...
import { probabilidadHeladaMatinal } from './probabilidad-helada-matinal';
...
import { profundidadCampoApertura } from './profundidad-campo-apertura';
...
import { compute as compute__promedio_mediana_moda_rango } from './promedio-mediana-moda-rango';
...
import { promptCachingAnthropicAhorroMensual } from './prompt-caching-anthropic-ahorro-mensual';
...
import { proyeccionVentasInversionRoasForecast } from './proyeccion-ventas-inversion-roas-forecast';
...
import { compute as compute__puente_feriado_fines_semana_largos_argentina_2026 } from './puente-feriado-fines-semana-largos-argentina-2026';
...
import { puntajeApgar } from './puntaje-apgar';
...
import { ragChunkingTokensOverlapOptimo } from './rag-chunking-tokens-overlap-optimo';
import { compute as compute__rag_vector_db_pinecone_pgvector_costo_mensual } from './rag-vector-db-pinecone-pgvector-costo-mensual';
...
import { recordRonaldoCompetencia } from './record-ronaldo-competencia';
import { recuperacionFracturaTibiaPerone } from './recuperacion-fractura-tibia-perone';
import { recuperacionIsquiotibial } from './recuperacion-isquiotibial';
import { recuperacionLca } from './recuperacion-lca';
...
import { compute as compute__reembolso_iva_turista_extranjero_tax_free_uruguay_chile } from './reembolso-iva-turista-extranjero-tax-free-uruguay-chile';
...
import { relocationPackageMudanzaInternacionalEmpresa } from './relocation-package-mudanza-internacional-empresa';
...
import { rendimientoReaccionQuimica } from './rendimiento-reaccion-quimica';
...
import { rentabilidadAlquilerCapRate } from './rentabilidad-alquiler-cap-rate';
...
import { rentabilidadStaking } from './rentabilidad-staking';
...
import { compute as compute__restaking_eigenlayer_points_airdrop_projection } from './restaking-eigenlayer-points-airdrop-projection';
import { restakingEigenlayerRendimientoEth } from './restaking-eigenlayer-rendimiento-eth';
...
import { retornoFutbolPostCovid } from './retorno-futbol-post-covid';
...
import { riesgoCardiovascularFramingham } from './riesgo-cardiovascular-framingham';
import { riesgoDiabetesFindrisc as riesgoDiabetesFindrisc__riesgo_diabetes_findrisc } from './riesgo-diabetes-findrisc';
import { riesgoDiabetesFindrisc } from './riesgo-diabetes-findrisc-v2';
...
import { roiMineriaCripto } from './roi-mineria-cripto';
...
import { roiTransferJugador } from './roi-transfer-jugador';
...
import { runesBitcoinProtocoloFeeMint } from './runes-bitcoin-protocolo-fee-mint';
...
import { compute as compute__rwa_ondo_mountain_protocol_yield_tesoros_eeuu } from './rwa-ondo-mountain-protocol-yield-tesoros-eeuu';
...
import { saunaFinlandesaFrecuenciaMortalidadCardio } from './sauna-finlandesa-frecuencia-mortalidad-cardio';
import { compute as compute__savings_goal_monthly_amount_calculator } from './savings-goal-monthly-amount-calculator';
import { scoreApgarNeonatal } from './score-apgar-neonatal';
...
import { seguroAutoGpsInmovilizadorDescuento } from './seguro-auto-gps-inmovilizador-descuento';
...
import { seguroVidaTemporalVsPermanentePrima } from './seguro-vida-temporal-vs-permanente-prima';
...
import { sofaTamanoLiving } from './sofa-tamano-living';
import { spargeWaterVolumen } from './sparge-water-volumen';
import { spartanRaceTrifectaTiempoPodio } from './spartan-race-trifecta-tiempo-podio';
...
import { compute as compute__stablecoin_yield_comparativa_aave_morpho_pendle_mejor } from './stablecoin-yield-comparativa-aave-morpho-pendle-mejor';
...
import { compute as compute__streaming_vs_batch_llm_latencia_costo_tradeoff } from './streaming-vs-batch-llm-latencia-costo-tradeoff';
...
import { tamanoSalaAcustica } from './tamano-sala-acustica';
...
import { compute as compute__tarifa_freelance_hora_argentina_cliente_exterior_deel } from './tarifa-freelance-hora-argentina-cliente-exterior-deel';
...
import { tasaMetabolicaReposo } from './tasa-metabolica-reposo';
import { tasaMetabolicaReposoKatch } from './tasa-metabolica-reposo-katch';
...
import { tiempoAnadidoPromedio } from './tiempo-anadido-promedio';
...
import { tiempoDescongeladoPeso } from './tiempo-descongelado-peso';
...
import { tiempoEstudioExamen } from './tiempo-estudio-examen';
...
import { tiempoSeguroSolUvFitzpatrick } from './tiempo-seguro-sol-uv-fitzpatrick';
...
import { tipoPielTest } from './tipo-piel-test';
...
import { compute as compute__tmb_metabolismo_basal_mifflin } from './tmb-metabolismo-basal-mifflin';
...
import { trivialPuntosNecesarios } from './trivial-puntos-necesarios';
...
import { videoDuracionIdealPlataforma } from './video-duracion-ideal-plataforma';
...
import { compute as compute__vinilo_coleccion_presupuesto_precios_segunda_mano_nuevo } from './vinilo-coleccion-presupuesto-precios-segunda-mano-nuevo';
...
import { compute as compute__vino_por_mesa_evento_tinto_blanco_espumante } from './vino-por-mesa-evento-tinto-blanco-espumante';
...
import { visaTalentoPortugalTrabajadorRemotoArg } from './visa-talento-portugal-trabajador-remoto-arg';
...
import { compute as compute__vitamina_d_deficiencia_suplementacion_dosis_edad } from './vitamina-d-deficiencia-suplementacion-dosis-edad';
...
import { vo2maxEstimadoSinTest } from './vo2max-estimado-sin-test';
...
import { walletHardwareLedgerTrezorAmortizacionAnos } from './wallet-hardware-ledger-trezor-amortizacion-anos';
...
import { xaExpectedAssists } from './xa-expected-assists';
import { xgExpectedGoals } from './xg-expected-goals';
...
import { youtubeShortsRpmIngreso } from './youtube-shorts-rpm-ingreso';
...
export const formulas: Record<string, (inputs: any) => any> = {
  ...
  'abertura-pvc-vs-aluminio-ahorro-anual': aberturaPvcVsAluminioAhorroAnual,
  ...
  'actualizacion-alquiler-irav-espana': actualizacionAlquilerIravEspana,
  'acuario-iluminacion-watts-litros-plantado': acuarioIluminacionWattsLitrosPlantado,
  ...
  'agent-tokens-loop-recursion-presupuesto-mensual': compute__agent_tokens_loop_recursion_presupuesto_mensual,
  'agente-ia-mcp-servidor-costo-mensual': agenteIaMcpServidorCostoMensual,
  ...
  'agua-diaria-litros-segun-peso': compute__agua_diaria_litros_segun_peso,
  ...
  'ahorro-futuro-hijo-universidad-18-anos': compute__ahorro_futuro_hijo_universidad_18_anos,
  'ahorro-gnc-vs-nafta-anual-ars': ahorroGncVsNaftaAnualArs,
  'ahorro-hormiga': ahorroHormiga,
  'ahorro-led-vs-comun': ahorroLedVsComun,
  ...
  'airdrop-elegibilidad-wallet-score-puntaje': airdropElegibilidadWalletScorePuntaje,
  ...
  'alfombra-tamano-living': alfombraTamanoLiving,
  ...
  'amortizacion-pase-fifa': amortizacionPaseFifa,
  ...
  'aprender-portugues-brasil-vs-portugal-tiempo': compute__aprender_portugues_brasil_vs_portugal_tiempo,
  ...
  'asistencias-por-90': asistenciasPor90,
  ...
  'axolotl-acuario-tamano-temperatura-litros': compute__axolotl_acuario_tamano_temperatura_litros,
  ...
  'balanceo-ecuacion-quimica': balanceoEcuacionQuimica,
  ...
  'batch-api-openai-anthropic-50-descuento-cuando': compute__batch_api_openai_anthropic_50_descuento_cuando,
  ...
  'beta-accion-riesgo': betaAccionRiesgo,
  'beta-hcg': betaHcg,
  'biberones-necesarios-primera-infancia': biberonesNecesariosPrimeraInfancia,
  'bichon-maltes-grooming-frecuencia-costo-anual': compute__bichon_maltes_grooming_frecuencia_costo_anual,
  'bicicleta-electrica-asistida-tco-mes-vs-auto-moto': compute__bicicleta_electrica_asistida_tco_mes_vs_auto_moto,
  ...
  'bitcoin-cpa-iva-trader-argentina-impuestos-2026': compute__bitcoin_cpa_iva_trader_argentina_impuestos_2026,
  ...
  'bjj-cinturon-grados-tiempo-promedio': bjjCinturonGradosTiempoPromedio,
  'black-friday-descuento-real': blackFridayDescuentoReal,
  ...
  'body-fat-jackson-pollock-calculator': compute__body_fat_jackson_pollock_calculator,
  ...
  'bosman-libre-costo': bosmanLibreCosto,
  ...
  'break-even-campana-publicitaria': breakEvenCampanaPublicitaria,
  ...
  'bridging-stablecoin-arbitrum-optimism-fee': bridgingStablecoinArbitrumOptimismFee,
  'burn-rate-runway': burnRateRunway,
  'burnout-indice-carga-laboral-test-mbi': burnoutIndiceCargaLaboralTestMbi,
  'burnout-test-maslach-puntaje-online-empleado': compute__burnout_test_maslach_puntaje_online_empleado,
  'caballo-pension-mes-club-hipico': caballoPensionMesClubHipico,
  ...
  'cac-payback-meses-recuperar-cliente': cacPaybackMesesRecuperarCliente,
  ...
  'calculadora-calorias-quemadas-caminando': caloriasQuemadasCaminando,
  ...
  'calorias-arquero-futbol': caloriasArqueroFutbol,
  ...
  'calorias-crossfit-wod': caloriasCrossfitWod,
  'calorias-cuerda': caloriasCuerda,
  'calorias-delantero': caloriasDelantero,
  ...
  'calorias-pickleball': caloriasPickleball,
  ...
  'capacidad-tanque-agua-litros': capacidadTanqueAguaLitros,
  ...
  'cargador-auto-electrico-hogar-7kw-22kw': cargadorAutoElectricoHogar7Kw22Kw,
  'cargador-hogar-wallbox-vs-publico-costo-anual': compute__cargador_hogar_wallbox_vs_publico_costo_anual,
  ...
  'cigarrillos-ahorro': cigarrillosAhorro,
  ...
  'cisterna-tanque-agua-litros-personas-presion': compute__cisterna_tanque_agua_litros_personas_presion,
  ...
  'claude-code-costo-mensual-uso-developer': claudeCodeCostoMensualUsoDeveloper,
  ...
  'clean-sheets-porcentaje': cleanSheetsPorcentaje,
  ...
  'coliving-precio-mes-bali-medellin-mexico': colivingPrecioMesBaliMedellinMexico,
  ...
  'comida-golden-retriever-cantidad-cachorro-adulto': compute__comida_golden_retriever_cantidad_cachorro_adulto,
  ...
  'comision-broker-cocos-iol-bull-comparativa': comisionBrokerCocosIolBullComparativa,
  ...
  'comprar-acciones-bvc-colombia-comisiones-impuesto': compute__comprar_acciones_bvc_colombia_comisiones_impuesto,
  ...
  'computo-prision-preventiva': computoPrisionPreventiva,
  ...
  'conejo-alimento-pellet-heno-mes-kg': conejoAlimentoPelletHenoMesKg,
  ...
  'conmocion-cerebral-protocolo-fifa': conmocionCerebralProtocoloFifa,
  ...
  'conversion-cripto-ars': conversionCriptoArs,
  ...
  'conversor-anos-luz-a-kilometros': conversorAnosLuzAKilometros,
  'conversor-arrobas-a-kilogramos': conversorArrobasAKilogramos,
  'conversor-atmosferas-a-pascales': conversorAtmosferasAPascales,
  'conversor-bar-a-psi': conversorBarAPsi,
  'conversor-barriles-a-litros': conversorBarrilesALitros,
  ...
  'conversor-bytes-a-kilobytes': conversorBytesAKilobytes,
  'conversor-calorias-a-joules': conversorCaloriasAJoules,
  'conversor-celsius-a-fahrenheit': conversorCelsiusAFahrenheit,
  'conversor-celsius-a-kelvin': conversorCelsiusAKelvin,
  'conversor-centimetros-a-pulgadas': conversorCentimetrosAPulgadas,
  'conversor-cuadras-a-metros': conversorCuadrasAMetros,
  'conversor-cuartos-a-litros': conversorCuartosALitros,
  'conversor-cucharadas-a-mililitros': conversorCucharadasAMililitros,
  'conversor-cucharaditas-a-mililitros': conversorCucharaditasAMililitros,
  'conversor-dias-a-horas': conversorDiasAHoras,
  'conversor-fahrenheit-a-celsius': conversorFahrenheitACelsius,
  'conversor-fahrenheit-a-celsius-horno': conversorFahrenheitACelsiusHorno,
  'conversor-fahrenheit-a-kelvin': conversorFahrenheitAKelvin,
  'conversor-galones-a-litros': conversorGalonesALitros,
  'conversor-gb-a-mb': conversorGbAMb,
  'conversor-gb-a-tb': conversorGbATb,
  'conversor-grados-a-gradianes': conversorGradosAGradianes,
  'conversor-grados-a-radianes': conversorGradosARadianes,
  ...
  'conversor-kelvin-a-celsius': conversorKelvinACelsius,
  'conversor-kilogramos-a-gramos': conversorKilogramosAGramos,
  'conversor-kilogramos-a-libras': conversorKilogramosALibras,
  'conversor-kilometros-a-millas': conversorKilometrosAMillas,
  'conversor-kilometros-cuadrados-a-millas-cuadradas': conversorKilometrosCuadradosAMillasCuadradas,
  'conversor-kmh-a-mph': conversorKmhAMph,
  'conversor-kmh-a-ms': conversorKmhAMs,
  'conversor-kw-a-hp': conversorKwAHp,
  'conversor-kwh-a-calorias': conversorKwhACalorias,
  'conversor-kwh-a-joules': conversorKwhAJoules,
  'conversor-ladrillos-por-metro-cuadrado': conversorLadrillosPorMetroCuadrado,
  'conversor-leguas-a-kilometros': conversorLeguasAKilometros,
  'conversor-libras-a-gramos': conversorLibrasAGramos,
  'conversor-libras-a-kilogramos': conversorLibrasAKilogramos,
  'conversor-libras-a-onzas': conversorLibrasAOnzas,
  'conversor-litros-a-galones': conversorLitrosAGalones,
  'conversor-litros-pintura-por-metro-cuadrado': conversorLitrosPinturaPorMetroCuadrado,
  'conversor-mach-a-kmh': conversorMachAKmh,
  'conversor-manzanas-a-hectareas': conversorManzanasAHectareas,
  'conversor-mb-a-gb': conversorMbAGb,
  'conversor-mbps-a-mb-s': conversorMbpsAMbS,
  'conversor-meses-a-semanas': conversorMesesASemanas,
  'conversor-metros-a-pies': conversorMetrosAPies,
  'conversor-metros-a-yardas': conversorMetrosAYardas,
  'conversor-metros-cuadrados-a-pies-cuadrados': conversorMetrosCuadradosAPiesCuadrados,
  'conversor-metros-cubicos-a-litros': conversorMetrosCubicosALitros,
  ...
  'conversor-miligramos-a-gramos': conversorMiligramosAGramos,
  ...
  'conversor-millas-a-kilometros': conversorMillasAKilometros,
  'conversor-millas-nauticas-a-kilometros': conversorMillasNauticasAKilometros,
  'conversor-minutos-a-segundos': conversorMinutosASegundos,
  'conversor-mmhg-a-kpa': conversorMmhgAKpa,
  ...
  'conversor-pies-cuadrados-a-metros-cuadrados': conversorPiesCuadradosAMetrosCuadrados,
  'conversor-pies-cubicos-a-metros-cubicos': conversorPiesCubicosAMetrosCubicos,
  'conversor-pintas-a-litros': conversorPintasALitros,
  'conversor-pixeles-a-pulgadas-dpi': conversorPixelesAPulgadasDpi,
  'conversor-psi-a-bar': conversorPsiABar,
  'conversor-pulgadas-a-centimetros': conversorPulgadasACentimetros,
  'conversor-pulgadas-a-milimetros': conversorPulgadasAMilimetros,
  'conversor-pulgadas-cuadradas-a-centimetros-cuadrados': conversorPulgadasCuadradasACentimetrosCuadrados,
  'conversor-quilates-a-gramos': conversorQuilatesAGramos,
  'conversor-radianes-a-grados': conversorRadianesAGrados,
  'conversor-semanas-a-dias': conversorSemanasADias,
  'conversor-stones-a-kilogramos': conversorStonesAKilogramos,
  ...
  'conversor-toneladas-a-kilogramos': conversorToneladasAKilogramos,
  ...
  'conversor-yardas-a-metros': conversorYardasAMetros,
  ...
  'costo-abono-bundesliga-premier': costoAbonoBundesligaPremier,
  'costo-adquisicion-seguidor-pago-paid-social': costoAdquisicionSeguidorPagoPaidSocial,
  ...
  'costo-mascota-mensual': costoMascotaMensual,
  ...
  'costo-por-lead-cpl-campana': costoPorLeadCplCampana,
  ...
  'coworking-precio-mes-flex-fijo-comparativa': coworkingPrecioMesFlexFijoComparativa,
  'cpa': cpa,
  'cpa-maximo-rentable-target-cpa': cpaMaximoRentableTargetCpa,
  ...
  'cripto-cedears-versus-usd-broker-rentabilidad-ar': compute__cripto_cedears_versus_usd_broker_rentabilidad_ar,
  ...
  'cuna-colecho-edad-transicion-cama-ninos': cunaColechoEdadTransicionCamaNinos,
  'cuota-12': cuota12,
  ...
  'dao-quorum-propuesta-votacion-token': daoQuorumPropuestaVotacionToken,
  ...
  'deel-vs-payoneer-vs-wise-comision-empleado-eeuu': compute__deel_vs_payoneer_vs_wise_comision_empleado_eeuu,
  ...
  'depreciacion-valor-jugador-edad': depreciacionValorJugadorEdad,
  'depresion-posparto-test': depresionPospartoTest,
  'derechos-imagen-comision': derechosImagenComision,
  ...
  'descenso-brasileirao': descensoBrasileirao,
  'descenso-bundesliga': descensoBundesliga,
  ...
  'descenso-premier-league': descensoPremierLeague,
  ...
  'detector-humedad-pared-tipo-tratamiento-costo': compute__detector_humedad_pared_tipo_tratamiento_costo,
  ...
  'dilucion-solucion-c1v1': dilucionSolucionC1v1,
  ...
  'dividend-yield-accion': dividendYieldAccion,
  ...
  'dps-damage-per-second': dpsDamagePerSecond,
  'drawdown-maximo-aceptable': drawdownMaximoAceptable,
  'drawdown-maximo-inversion': drawdownMaximoInversion,
  ...
  'edad-gestacional-ecografia-corona-rabadilla': compute__edad_gestacional_ecografia_corona_rabadilla,
  'edad-gestacional-perro-gato-camada-fecha-parto': compute__edad_gestacional_perro_gato_camada_fecha_parto,
  ...
  'edad-perro-gato-anos-humanos-tabla-2026-actualizada': compute__edad_perro_gato_anos_humanos_tabla_2026_actualizada,
  ...
  'efectividad-tipos-pokemon': efectividadTiposPokemon,
  'efectividad-tiros-al-arco': efectividadTirosAlArco,
  ...
  'elo-rating-futbol': eloRatingFutbol,
  ...
  'embargo-sueldo-maximo': embargoSueldoMaximo,
  'embargo-sueldo-porcentaje-maximo': embargoSueldoPorcentajeMaximo,
  'embedding-vector-pinecone-weaviate-costo-mes': embeddingVectorPineconeWeaviateCostoMes,
  ...
  'emigrar-uruguay-presupuesto-primer-ano-familia': compute__emigrar_uruguay_presupuesto_primer_ano_familia,
  ...
  'escala-dolor-numerica': escalaDolorNumerica,
  ...
  'escalada-grado-frances-yds-conversion': escaladaGradoFrancesYdsConversion,
  ...
  'escape-room-probabilidad': escapeRoomProbabilidad,
  ...
  'ethereum-l2-base-arbitrum-optimism-fee-comparativa': ethereumL2BaseArbitrumOptimismFeeComparativa,
  ...
  'experiencia-nivel-mmorpg': experienciaNivelMmorpg,
  ...
  'factor-clima-mascotas': factorClimaMascotas,
  ...
  'fecha-ovulacion-ventana-fertil': compute__fecha_ovulacion_ventana_fertil,
  ...
  'fgts-multa-40-rescisao': compute__fgts_multa_40_rescisao,
  ...
  'financiamento-sac-vs-price': financiamentoSacVsPrice,
  'financiamento-veiculo-cdc-banco': compute__financiamento_veiculo_cdc_banco,
  'fine-tuning-llama-costo-dataset-tokens': fineTuningLlamaCostoDatasetTokens,
  'fine-tuning-openai-vs-rag-cuando-conviene': compute__fine_tuning_openai_vs_rag_cuando_conviene,
  ...
  'finiquito-despido-injustificado-mexico': finiquitoDespidoInjustificadoMexico,
  ...
  'freelance-tarifa-hora-vs-paquete-fijo-cuando-conviene': compute__freelance_tarifa_hora_vs_paquete_fijo_cuando_conviene,
  ...
  'fumigacion-frecuencia-hogar': fumigacionFrecuenciaHogar,
  ...
  'generador-contrasena-segura': generadorContrasenaSegura,
  ...
  'golden-hour-horario': goldenHourHorario,
  ...
  'hashtag-alcance-estimado': hashtagAlcanceEstimado,
  ...
  'hidratacion-diaria-personalizada': hidratacionDiariaPersonalizada,
  ...
  'hidratacion-futbolista': hidratacionFutbolista,
  ...
  'hipoteca-ciudad-procrear': hipotecaCiudadProcrear,
  ...
  'hipoteca-uva-bbva': hipotecaUvaBbva,
  ...
  'home-advantage-liga': homeAdvantageLiga,
  ...
  'honorarios-abogado-laboral-mexico': honorariosAbogadoLaboralMexico,
  ...
  'honorarios-escribano-pba': honorariosEscribanoPba,
  ...
  'hourly-to-annual-salary-converter': compute__hourly_to_annual_salary_converter,
  'hours-between-times-calculator': compute__hours_between_times_calculator,
  'huella-carbono': huellaCarbono__huella_carbono,
  ...
  'huerta-produccion-m2': huertaProduccionM2,
  ...
  'imagen-ai-dall-e-3-vs-midjourney-stable-diffusion-pixel': compute__imagen_ai_dall_e_3_vs_midjourney_stable_diffusion_pixel,
  ...
  'impatriado-beckham-espana-impuesto-relocacion': compute__impatriado_beckham_espana_impuesto_relocacion,
  ...
  'impuesto-bebidas-azucaradas-2025-colombia': compute__impuesto_bebidas_azucaradas_2025_colombia,
  ...
  'impuesto-nomada-digital-residencia-fiscal-paises': compute__impuesto_nomada_digital_residencia_fiscal_paises,
  'impuesto-pais-mep-blue-eliminacion-impacto-importacion': compute__impuesto_pais_mep_blue_eliminacion_impacto_importacion,
  ...
  'impuesto-seguro-vida-chile-prima-deduccion': compute__impuesto_seguro_vida_chile_prima_deduccion,
  ...
  'indice-tobillo-brazo': indiceTobilloBrazo,
  ...
  'instagram-ads-presupuesto-cpm-cpr-roi-2026': compute__instagram_ads_presupuesto_cpm_cpr_roi_2026,
  ...
  'iva-espana-2026-21-tipo-general-formula': compute__iva_espana_2026_21_tipo_general_formula,
  ...
  'japones-jlpt-n5-n4-n3-horas-meta-aprobar': compute__japones_jlpt_n5_n4_n3_horas_meta_aprobar,
  ...
  'kdrama-bingear-horas-temporadas-recomendado': compute__kdrama_bingear_horas_temporadas_recomendado,
  ...
  'lactario-leche-materna-extraccion-frecuencia-stock': lactarioLecheMaternaExtraccionFrecuenciaStock,
  ...
  'licencia-adopcion-lct': licenciaAdopcionLct,
  ...
  'licencia-matrimonio-lct-158': licenciaMatrimonioLct158,
  ...
  'liga-mx-liguilla': ligaMxLiguilla,
  ...
  'llm-context-window-200k-vs-1m-cuando-conviene': compute__llm_context_window_200k_vs_1m_cuando_conviene,
  ...
  'lollapalooza-argentina-2026-precio-abono-dia': lollapaloozaArgentina2026PrecioAbonoDia,
  ...
  'magnitud-aparente-absoluta': magnitudAparenteAbsoluta,
  ...
  'margen-seguridad-inversion': margenSeguridadInversion,
  ...
  'master-mba-roi-costo-vs-aumento-sueldo-anos-recuperar': compute__master_mba_roi_costo_vs_aumento_sueldo_anos_recuperar,
  'master-oficial-titulo-propio-precio-espana': compute__master_oficial_titulo_propio_precio_espana,
  'mate-yerba-cantidad-mate-cebados-dia-grupo': compute__mate_yerba_cantidad_mate_cebados_dia_grupo,
  ...
  'mcp-server-costo-hosting-cloudflare-vs-aws': compute__mcp_server_costo_hosting_cloudflare_vs_aws,
  'mecanismo-solidaridad-fifa': mecanismoSolidaridadFifa,
  'media-geometrica-armonica': mediaGeometricaArmonica,
  'media-mediana-moda': mediaMedianaModa,
  'media-mediana-moda-rango-estadistica': mediaMedianaModaRangoEstadistica,
  'media-ponderada': mediaPonderada,
  'meditacion-minutos-ansiedad-cortisol-impacto': compute__meditacion_minutos_ansiedad_cortisol_impacto,
  'meditacion-minutos-beneficio': meditacionMinutosBeneficio,
  ...
  'melatonina-dosis-jet-lag-edad-tomar-cuando': compute__melatonina_dosis_jet_lag_edad_tomar_cuando,
  ...
  'mezcla-audio-headroom-db': mezclaAudioHeadroomDb,
  'mezcla-presupuesto-canales-marketing': mezclaPresupuestoCanalesMarketing,
  ...
  'midjourney-vs-dalle-costo-imagen-comparativa': midjourneyVsDalleCostoImagenComparativa,
  ...
  'modelo-local-ollama-vs-api-openai-costo-tco': compute__modelo_local_ollama_vs_api_openai_costo_tco,
  ...
  'mrr': mrr,
  'mudanza-cajas-estimacion': mudanzaCajasEstimacion,
  ...
  'node-validador-ethereum-32-eth-rendimiento': nodeValidadorEthereum32EthRendimiento,
  'nomada-digital-residencia-fiscal-impuestos': nomadaDigitalResidenciaFiscalImpuestos,
  ...
  'one-rep-max-epley-brzycki-calculator': compute__one_rep_max_epley_brzycki_calculator,
  ...
  'padel-handicap-puntaje-ranking-aft': padelHandicapPuntajeRankingAft,
  'padel-pelota-presion-altura-pico': padelPelotaPresionAlturaPico,
  ...
  'paro-autonomos-cese-actividad-espana': paroAutonomosCeseActividadEspana,
  'paro-espana-sepe': paroEspanaSepe,
  ...
  'payroll-internacional-deel-remote-costo-empleado': payrollInternacionalDeelRemoteCostoEmpleado,
  ...
  'perro-anciano-7-anos-suplementos-diarios': compute__perro_anciano_7_anos_suplementos_diarios,
  'perro-departamento-apto': perroDepartamentoApto,
  'perro-paseador-tarifa-hora-zona-caba': perroPaseadorTarifaHoraZonaCaba,
  ...
  'peso-ideal-formula': pesoIdealFormula,
  'peso-ideal-formula-lorentz-devine': pesoIdealFormulaLorentzDevine,
  'peso-ideal-formulas-comparativa-broca-devine-robinson': compute__peso_ideal_formulas_comparativa_broca_devine_robinson,
  ...
  'peso-ideal-perro-raza': pesoIdealPerroRaza,
  ...
  'pintura-pared-litros-m2': pinturaParedLitrosM2,
  ...
  'piso-radiante-electrico-vs-agua-costo': pisoRadianteElectricoVsAguaCosto,
  ...
  'plusvalia-revalorizacion-inmueble-proyectada': plusvaliaRevalorizacionInmuebleProyectada,
  'pnc-madre-7-hijos': pncMadre7Hijos,
  'pnc-vejez-70-anos': pncVejez70Anos,
  ...
  'pomodoro-output-real-distracciones-promedio': compute__pomodoro_output_real_distracciones_promedio,
  'pomodoro-sesiones-dia-productividad-horas': pomodoroSesionesDiaProductividadHoras,
  'poodle-toy-vs-mediano-grande-comida-diferencia': compute__poodle_toy_vs_mediano_grande_comida_diferencia,
  ...
  'portero-electrico-vs-camara-ip-departamento-comparativa': compute__portero_electrico_vs_camara_ip_departamento_comparativa,
  ...
  'precio-internet-fibra-tigo-claro-etb-2026-promo': compute__precio_internet_fibra_tigo_claro_etb_2026_promo,
  ...
  'preescolar-jardin-cuota-mensual-comparativa-paises': preescolarJardinCuotaMensualComparativaPaises,
  ...
  'premios-copa-america': premiosCopaAmerica,
  'premios-copa-argentina': premiosCopaArgentina,
  'premios-libertadores-ronda': premiosLibertadoresRonda,
  'premios-liga-profesional-afa': premiosLigaProfesionalAfa,
  'premios-mundial-2026-seleccion': premiosMundial2026Seleccion,
  'premios-mundial-clubes-2025': premiosMundialClubes2025,
  'premios-mundial-clubes-fifa': premiosMundialClubesFifa,
  ...
  'presion-arterial-rango': presionArterialRango,
  'presion-arterial-tabla-normal-hipertension': presionArterialTablaNormalHipertension,
  'presion-arterial-tension-categorias-oms-2026': compute__presion_arterial_tension_categorias_oms_2026,
  ...
  'presupuesto-pauta-por-objetivo': presupuestoPautaPorObjetivo,
  ...
  'probabilidad-aprobar-multiple-choice': probabilidadAprobarMultipleChoice,
  ...
  'probabilidad-helada-matinal': probabilidadHeladaMatinal,
  ...
  'profundidad-campo-apertura': profundidadCampoApertura,
  ...
  'promedio-mediana-moda-rango': compute__promedio_mediana_moda_rango,
  ...
  'prompt-caching-anthropic-ahorro-mensual': promptCachingAnthropicAhorroMensual,
  ...
  'proyeccion-ventas-inversion-roas-forecast': proyeccionVentasInversionRoasForecast,
  ...
  'puente-feriado-fines-semana-largos-argentina-2026': compute__puente_feriado_fines_semana_largos_argentina_2026,
  ...
  'rag-chunking-tokens-overlap-optimo': ragChunkingTokensOverlapOptimo,
  'rag-vector-db-pinecone-pgvector-costo-mensual': compute__rag_vector_db_pinecone_pgvector_costo_mensual,
  ...
  'record-ronaldo-competencia': recordRonaldoCompetencia,
  'recuperacion-fractura-tibia-perone': recuperacionFracturaTibiaPerone,
  'recuperacion-isquiotibial': recuperacionIsquiotibial,
  'recuperacion-lca': recuperacionLca,
  ...
  'reembolso-iva-turista-extranjero-tax-free-uruguay-chile': compute__reembolso_iva_turista_extranjero_tax_free_uruguay_chile,
  ...
  'relocation-package-mudanza-internacional-empresa': relocationPackageMudanzaInternacionalEmpresa,
  ...
  'rendimiento-reaccion-quimica': rendimientoReaccionQuimica,
  ...
  'rentabilidad-alquiler-cap-rate': rentabilidadAlquilerCapRate,
  ...
  'rentabilidad-staking': rentabilidadStaking,
  ...
  'restaking-eigenlayer-points-airdrop-projection': compute__restaking_eigenlayer_points_airdrop_projection,
  'restaking-eigenlayer-rendimiento-eth': restakingEigenlayerRendimientoEth,
  ...
  'retorno-futbol-post-covid': retornoFutbolPostCovid,
  ...
  'riesgo-cardiovascular-framingham': riesgoCardiovascularFramingham,
  'riesgo-diabetes-findrisc': riesgoDiabetesFindrisc__riesgo_diabetes_findrisc,
  'riesgo-diabetes-findrisc-v2': riesgoDiabetesFindrisc,
  ...
  'roi-mineria-cripto': roiMineriaCripto,
  ...
  'roi-transfer-jugador': roiTransferJugador,
  ...
  'runes-bitcoin-protocolo-fee-mint': runesBitcoinProtocoloFeeMint,
  ...
  'rwa-ondo-mountain-protocol-yield-tesoros-eeuu': compute__rwa_ondo_mountain_protocol_yield_tesoros_eeuu,
  ...
  'sauna-finlandesa-frecuencia-mortalidad-cardio': saunaFinlandesaFrecuenciaMortalidadCardio,
  'savings-goal-monthly-amount-calculator': compute__savings_goal_monthly_amount_calculator,
  'score-apgar-neonatal': scoreApgarNeonatal,
  ...
  'seguro-auto-gps-inmovilizador-descuento': seguroAutoGpsInmovilizadorDescuento,
  ...
  'seguro-vida-temporal-vs-permanente-prima': seguroVidaTemporalVsPermanentePrima,
  ...
  'sofa-tamano-living': sofaTamanoLiving,
  'sparge-water-volumen': spargeWaterVolumen,
  'spartan-race-trifecta-tiempo-podio': spartanRaceTrifectaTiempoPodio,
  ...
  'stablecoin-yield-comparativa-aave-morpho-pendle-mejor': compute__stablecoin_yield_comparativa_aave_morpho_pendle_mejor,
  ...
  'streaming-vs-batch-llm-latencia-costo-tradeoff': compute__streaming_vs_batch_llm_latencia_costo_tradeoff,
  ...
  'tamano-sala-acustica': tamanoSalaAcustica,
  ...
  'tarifa-freelance-hora-argentina-cliente-exterior-deel': compute__tarifa_freelance_hora_argentina_cliente_exterior_deel,
  ...
  'tasa-metabolica-reposo': tasaMetabolicaReposo,
  'tasa-metabolica-reposo-katch': tasaMetabolicaReposoKatch,
  ...
  'tiempo-anadido-promedio': tiempoAnadidoPromedio,
  ...
  'tiempo-descongelado-peso': tiempoDescongeladoPeso,
  ...
  'tiempo-estudio-examen': tiempoEstudioExamen,
  ...
  'tiempo-seguro-sol-uv-fitzpatrick': tiempoSeguroSolUvFitzpatrick,
  ...
  'tmb-metabolismo-basal-mifflin': compute__tmb_metabolismo_basal_mifflin,
  ...
  'trivial-puntos-necesarios': trivialPuntosNecesarios,
  ...
  'video-duracion-ideal-plataforma': videoDuracionIdealPlataforma,
  ...
  'vinilo-coleccion-presupuesto-precios-segunda-mano-nuevo': compute__vinilo_coleccion_presupuesto_precios_segunda_mano_nuevo,
  'vino-por-invitado-cena': vinoPorInvitadoCena,
  'vino-por-invitado-horas-evento': vinoPorInvitadoHorasEvento,
  'vino-por-mesa-evento-tinto-blanco-espumante': compute__vino_por_mesa_evento_tinto_blanco_espumante,
  ...
  'visa-talento-portugal-trabajador-remoto-arg': visaTalentoPortugalTrabajadorRemotoArg,
  ...
  'vitamina-d-deficiencia-suplementacion-dosis-edad': compute__vitamina_d_deficiencia_suplementacion_dosis_edad,
  ...
  'vo2max-estimado-sin-test': vo2maxEstimadoSinTest,
  ...
  'wallet-hardware-ledger-trezor-amortizacion-anos': walletHardwareLedgerTrezorAmortizacionAnos,
  ...
  'xa-expected-assists': xaExpectedAssists,
  'xg-expected-goals': xgExpectedGoals,
  ...
  'youtube-shorts-rpm-ingreso': youtubeShortsRpmIngreso,
