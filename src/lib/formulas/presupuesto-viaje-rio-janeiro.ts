/**
 * Calculadora de Presupuesto de Viaje a Río de Janeiro
 */
export interface PresupuestoViajeRioJaneiroInputs {
  dias: number;
  nivelHotel: string;
  personas: number;
  incluirVuelo: string;
}
export interface PresupuestoViajeRioJaneiroOutputs {
...
export function presupuestoViajeRioJaneiro(i: PresupuestoViajeRioJaneiroInputs): PresupuestoViajeRioJaneiroOutputs {
