/** Rate hora consultor de marketing freelance */
...
export function costoHoraConsultorMarketing(i: Inputs): Outputs {
  ...
  const _insight = {
    ...
    text: `Como consultor de marketing con **${anos} ${anos === 1 ? 'año' : 'años'}** de experiencia facturando a **${paisLbl[pais] || pais}**, un rate razonable ronda los **USD ${rateHora}/hora** (banda USD ${rateMin}–${rateMax}). No cobres por debajo de USD ${rateMin}: a esos clientes los educás a no valorar tu trabajo.`,
    tone: 'neutral',
    icon: '📈',
  };
  return {
