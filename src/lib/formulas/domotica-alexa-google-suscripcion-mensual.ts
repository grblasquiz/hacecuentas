...
export interface Outputs { costoSuscripcionesMensual: number; costoElectricidadMensual: number; costoTotalMensual: number; costoAnual: number; explicacion: string; _chart?: any; }
