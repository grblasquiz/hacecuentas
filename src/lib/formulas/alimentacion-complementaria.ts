...
export function alimentacionComplementaria(i: Inputs): Outputs {
  ...
  let titular = '', alimentos = '', textura = '', cantidad = '', frecuencia = '';

  if (edad < 6) {
    titular = 'Aún lactancia exclusiva';
    ...
    titular = 'Primeros sólidos: frutas y verduras';
    ...
    titular = 'Sumás proteínas y legumbres';
    ...
    titular = 'Casi todo: sin miel ni sal';
    ...
    titular = 'Comida familiar adaptada';
