...
export function fertilidadMasculinaEdad(i: Inputs): Outputs {
  ...
  if (edad < 30) {
    calidad = 'Óptima';
    parametros = 'Motilidad ~60%, morfología ~10-15%, fragmentación ADN baja.';
    ...
    calidad = 'Muy buena';
    parametros = 'Leve descenso de motilidad (~55%). Calidad general alta.';
    ...
    calidad = 'Buena con descenso leve';
    parametros = 'Motilidad ~50%, mayor fragmentación ADN (~20%).';
    ...
    calidad = 'Descenso moderado';
    parametros = 'Motilidad ~40-45%, fragmentación ADN 25-30%.';
    ...
    calidad = 'Descenso significativo';
    parametros = 'Motilidad ~35%, volumen reducido, fragmentación ADN 30-40%.';
