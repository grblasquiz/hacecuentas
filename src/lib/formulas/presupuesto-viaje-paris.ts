/**
 * Calculadora de Presupuesto de Viaje a París
 */
export interface PresupuestoViajeParisInputs {
  dias: number;
  nivelHotel: string;
  personas: number;
  incluirVuelo: string;
}
export interface PresupuestoViajeParisOutputs {
...
export function presupuestoViajeParis(i: PresupuestoViajeParisInputs): PresupuestoViajeParisOutputs {
