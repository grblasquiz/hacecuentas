...
export const room: DecisionRoom = {
  ...
  // — Wizard: primero los dos brutos (resultado preliminar), después afinar. —
  steps: [
    {
      title: 'Los dos sueldos',
      hint: 'El bruto actual y el de la oferta. Con esto ya comparamos el neto real.',
      fieldIds: ['brutoActual', 'brutoOferta'],
    },
    {
      title: 'Modalidad y traslado',
      hint: 'Días de oficina, transporte y comida: acá se esconde la diferencia real.',
      fieldIds: [
        'diasOficinaOferta',
        'diasOficinaActual',
        'transporteOferta',
    ...
    {
      title: 'Tu situación y beneficios',
      hint: 'Familia (para Ganancias), bonos y beneficios terminan de afinar el número.',
      fieldIds: [
        'conyuge',
        'hijos',
        'bonoAnualOferta',
        'bonoAnualActual',
        'valorBeneficiosOferta',
        'valorBeneficiosActual',
        'horasSemana',
      ],
    },
  ],
  presets: [
    {
      id: 'remoto-a-presencial',
      label: 'Remoto → presencial',
      hint: '+30% de bruto, pero 5 días de oficina con 90 min de viaje.',
      icon: '🚇',
      values: {
        brutoActual: 1500000,
        brutoOferta: 1950000,
    ...
    {
      id: 'salto-hibrido',
      label: 'Salto del 35%, mismo híbrido',
      hint: 'Cambio limpio: mejor sueldo con la misma modalidad de 3 días.',
      icon: '📈',
      values: {
        brutoActual: 1800000,
        brutoOferta: 2430000,
        ...
        diasOficinaActual: 3,
        diasOficinaOferta: 3,
        transporteActual: 4000,
        transporteOferta: 4000,
        comidaActual: 6000,
        comidaOferta: 6000,
        minutosViajeDia: 60,
        horasSemana: 45,
    ...
    {
      id: 'oferta-con-bono',
      label: 'Sube poco, pero con bono anual',
      hint: '+9% de bruto más un bono anual equivalente a un sueldo.',
      icon: '🎁',
      values: {
        brutoActual: 2200000,
        brutoOferta: 2400000,
