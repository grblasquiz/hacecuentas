...
export const CALC_TO_TABLA: Record<string, TablaRef> = {
  ...
  'calculadora-monotributo-2026': { slug: 'tabla-categorias-monotributo-2026', label: 'Tabla de categorías del monotributo 2026 (A a K)' },
  'calculadora-monotributo-categoria-ingresos-tope': { slug: 'tabla-categorias-monotributo-2026', label: 'Tabla de categorías del monotributo 2026 (A a K)' },
  'calculadora-iva-incluido-neto-discriminar': { slug: 'tabla-categorias-monotributo-2026', label: 'Tabla de categorías del monotributo 2026 (A a K)' },
  ...
  'calculadora-edad-perro-humano': { slug: 'tabla-peso-ideal-perros-por-raza', label: 'Tabla de peso ideal de perros por raza' },
